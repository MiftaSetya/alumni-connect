...
const MentorForumPage = () => {
  return (
    <MentorLayout title="Discussion Forum">
      <div className="space-y-6 w-full">
        <div className="flex items-center justify-between">
          <p className="text-muted-foreground">Share insights and answer student questions.</p>
          <Button className="gradient-primary text-primary-foreground" onClick={() => toast.success("New post form coming soon!")}>
...
export default MentorForumPage;
